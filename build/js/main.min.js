...
var accordionToggle = document.querySelectorAll('.accordion__toggle'); // Удаляю  класс "no-js" у футера проверив что элемент присутствует
...
var allElems = document.querySelectorAll('.accordion__item-header');
